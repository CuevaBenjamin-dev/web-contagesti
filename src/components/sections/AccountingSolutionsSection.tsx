...
//         <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.06fr)_minmax(0,0.94fr)] lg:gap-12 xl:gap-14">
//           <div className="lg:pr-4">
//             <div className="max-w-[760px]">
//               <h2 className="type-display-section text-pretty text-[var(--color-surface-white)]">
...
//               <p className="type-section-body mt-5 max-w-[740px] text-[var(--color-text-on-dark)] lg:mt-6">
...
//               <a
//                 href="#servicio-completo"
//                 className="interactive-scale-soft type-button inline-flex min-h-[72px] items-center justify-center rounded-[var(--radius-button)] bg-[var(--color-brand-green)] px-8 text-center text-white shadow-[var(--shadow-button-green)] sm:min-w-[264px]"
//               >
//                 Ver servicio completo
//               </a>

//               <a
//                 href="#solicitar-asesoria"
//                 className="interactive-scale-soft type-button inline-flex min-h-[72px] items-center justify-center rounded-[var(--radius-button)] bg-[var(--color-surface-white)] px-8 text-center text-[var(--color-brand-blue-strong)] shadow-[var(--shadow-button-neutral)] sm:min-w-[248px]"
//               >
//                 Solicitar asesoría
//               </a>
//             </div>
...
//                 <h3 className="type-panel-title mt-3 text-[var(--color-brand-blue-strong)]">
...
//                       <h4 className="type-card-title text-[var(--color-text-dark)]">
//                         {card.title}
//                       </h4>
...
//             <p className="type-note mx-auto mt-7 max-w-[430px] text-center text-[var(--color-text-note)]">
