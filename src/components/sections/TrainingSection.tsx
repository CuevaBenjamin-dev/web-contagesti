...
//   return (
//     <section className="bg-[var(--color-surface-base)] py-12 sm:py-14 lg:py-16">
...
//                   className="interactive-card-soft rounded-[var(--radius-card-md)] border border-[var(--color-border-soft)] bg-transparent p-6 sm:p-7"
//                 >
...
//                 className={[
//                   "interactive-card-soft overflow-hidden rounded-[var(--radius-card-lg)] border border-transparent shadow-[var(--shadow-card)]",
//                   activeCard === "entrepreneur" ? "interactive-card-soft-active" : "",
//                 ].join(" ")}
//               >
//                 <img
